...
class ScratchNet(Net):
    ...
    def __init__(self, cf, num_classes=21, pretrained=False, net_name='scratchnet'):
        super(ScratchNet, self).__init__(cf)

        #TODO: find a way to delete pretrained
