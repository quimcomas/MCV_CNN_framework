...
class SSD300(Net):
    ...
    def __init__(self, cf, num_classes=21, pretrained=False, net_name='ssd300'):
        super(SSD300, self).__init__(cf)
...
class SSD512(Net):
    ...
    def __init__(self, cf, num_classes=21, pretrained=False, net_name='ssd512'):
        super(SSD512, self).__init__(cf)
        self.num_classes = num_classes
