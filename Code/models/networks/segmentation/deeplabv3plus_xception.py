...
class DeepLabv3_xception(Net):
    def __init__(self, cf, nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True, net_name='DeepLabv3Plus'):
        if _print:
            print("Constructing DeepLabv3+ model...")
            print("Number of classes: {}".format(n_classes))
            print("Output stride: {}".format(os))
            print("Number of Input Channels: {}".format(nInputChannels))
        super(DeepLabv3_xception, self).__init__(cf)
        self.url = ''
