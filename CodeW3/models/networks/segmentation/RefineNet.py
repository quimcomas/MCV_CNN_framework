...
class RefineNet(nn.Module):
    ...
    def __init__(self, cf, num_classes=21, pretrained=False, net_name='refinet',block=Bottleneck,layers=[3, 4, 23, 3] ):
        ...
        if pretrained:
            key = '101_imagenet'
            url = models_urls[key]
            self.load_state_dict(maybe_download(key, url), strict=False)"""
