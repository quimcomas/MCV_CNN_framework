...
class ResNet(nn.Module):
    def __init__(self,cf,num_classes=21,pretrained=False,net_name='resi', downblock=Bottleneck, upblock=[3, 4, 23, 2], num_layers=22):
        ...
        self.conv1_1 = nn.ConvTranspose2d(64, num_classes, kernel_size=1, stride=1,
                                 bias=False)
