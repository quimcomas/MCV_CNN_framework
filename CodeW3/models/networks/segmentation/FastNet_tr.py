...
class FastNet(Net):
    ...
    '''
    IDEAS implemented:
    * SELU activation (https://arxiv.org/pdf/1706.02515.pdf, https://stackoverflow.com/questions/44621731/how-to-handle-the-batchnorm-layer-when-training-fully-convolutional-networks-by)
